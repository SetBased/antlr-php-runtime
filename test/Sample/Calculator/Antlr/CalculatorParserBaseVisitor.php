...
/**
 * This class provides an empty implementation of {@see CalculatorParserVisitor},
 * which can be extended to create a visitor which only needs to handle a subset
 * of the available methods.
 */
class CalculatorParserBaseVisitor extends AbstractParseTreeVisitor implements CalculatorParserVisitor
{
	/**
	 * {@inheritdoc}
	 *
